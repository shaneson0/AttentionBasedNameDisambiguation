...
def train(name, needtSNE=False, savefile=True):
    ...
    def get_embs():
        ...
        emb = sess.run(model.z, feed_dict=feed_dict)  # z_mean is better
        return emb
    ...
    for clusterepoch in range(FLAGS.clusterEpochs):
        ...
        for epoch in range(FLAGS.epochs):
            ...
            feed_dict = construct_feed_dict(adj_norm, adj_label, adj_norm2, adj_label2, features, placeholders, Clusterlabels, epoch, clusterepoch)
