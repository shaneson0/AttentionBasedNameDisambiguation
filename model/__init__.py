...
class DualGCNGraphFusion(Model):
    ...
    def _build(self):
        ...
        Inputs1 = tf.concat(tf.cast(self.hidden_1_2, tf.float32), tf.cast(self.hidden_2_2, tf.float32))
        Inputs2 = tf.concat(tf.cast(self.log_std_1, tf.float32), tf.cast(self.log_std_2, tf.float32))
