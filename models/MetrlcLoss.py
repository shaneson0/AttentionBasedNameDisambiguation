...
class OSM_CAA_Loss():
    def __init__(self, alpha=1.2, l=0.5, use_gpu=True, batch_size=32, beta=0.5):
        ...
        self.alpha = 1.5  # margin of weighted contrastive loss, as mentioned in the paper
        self.l = 0.998  # hyperparameter controlling weights of positive set and the negative set
