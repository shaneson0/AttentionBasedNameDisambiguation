...
class GlobalTripletModel:
    ...
    def create_triplet_model():
        ...
        )([pos_dist, neg_dist, raw_pos_dist, raw_neg_dist, atten_pos_dist, atten_neg_dist])
    ...
    def train_triplets_model(self):
        ...
        model.fit(X, np.ones((n_triplets, 2)), batch_size=64, epochs=10, shuffle=True, validation_split=0.2)
