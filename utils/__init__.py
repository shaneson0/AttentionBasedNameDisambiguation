...
def getSetting():
    ...
    flags.DEFINE_float('ReconstructVariable1',0.05 , 'Weight for the cluster loss --- CenterLoss .')
    flags.DEFINE_float('ReconstructVariable2', 1.0, 'Weight for the cluster loss --- CenterLoss .')
